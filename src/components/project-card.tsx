    ...
    <div className={`py-16 ${className}`}>
      <div className="max-w-6xl mx-auto px-6">
            ...
            <div className={`flex items-center justify-center`}>
              {media.type === "video" ? (
                ...
                <div className="w-full overflow-x-auto rounded-3xl border border-slate-200 bg-slate-50 shadow-sm">
                  <div className="flex snap-x snap-mandatory gap-4 px-4 py-4">
                    {photos.map((photo, photoIndex) => (
                      <div
                        key={photoIndex}
                        className="min-w-[300px] flex-shrink-0 snap-center rounded-3xl overflow-hidden"
                      >
                        <Image
          ...
          >
            <div className="space-y-8">
              ...
              {(detailedDescription || features) && (
                <StripedButton onClick={() => setIsModalOpen(true)}>
                  More Details
                </StripedButton>
              )}
            </div>
        ...
        {isModalOpen && (
          ...
          >
            <div
              className="relative w-full max-w-6xl h-[80vh] overflow-hidden rounded-[2rem] bg-white shadow-2xl"
              onClick={(event) => event.stopPropagation()}
            >
              <button
                type="button"
                onClick={() => setIsModalOpen(false)}
                className="absolute right-4 top-4 z-10 rounded-full border border-slate-200 bg-white px-3 py-1 text-3xl font-semibold text-[#0f1b61] shadow-sm transition hover:bg-slate-100"
              >
                ×
              </button>
              ...
              <div className="h-full overflow-hidden">
                <div className="border-b border-slate-200 px-6 py-5">
                  ...
                  <h2 className="mt-3 text-3xl font-bold text-[#0f1b61]">
                    {title}
                  </h2>
                </div>
                <div className="grid h-full grid-cols-1 md:grid-cols-[1.4fr_0.8fr] overflow-hidden">
                  <div className="overflow-y-auto px-6 py-6">
                    {media.type === "video" ? (
                      ...
                      <div className="flex h-[320px] gap-4 overflow-x-auto snap-x snap-mandatory rounded-3xl">
                        {photos.map((photo, photoIndex) => (
                          <div
                            key={photoIndex}
                    ...
                    <div className="mt-6">
                      <h3 className="text-2xl font-semibold text-[#0f1b61] mb-3">
                        Description
                      </h3>
                      <p className="whitespace-pre-line text-[#0f1b61] leading-relaxed text-base">
                  ...
                  <div className="overflow-y-auto border-t border-slate-200 px-6 py-6 md:border-t-0 md:border-l">
                    <div className="mb-8">
                      <h3 className="text-2xl font-semibold text-[#0f1b61] mb-4">
                        Tech Stack
                      </h3>
                      <div className="flex flex-wrap gap-3">
                        ...
                        <div className="flex flex-wrap gap-3">
                          {links.live && (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="inline-flex rounded-full border border-thirdy bg-thirdy/10 px-4 py-2 text-sm font-semibold text-thirdy transition hover:bg-thirdy/20"
                            >
                              Live Demo
                            </a>
                          )}
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          {features.map((feature, featureIndex) => (
                            ...
                            >
                              <span className="w-3 h-3 rounded-full bg-[#7f15e9] mt-2 mr-4 flex-shrink-0"></span>
                              {feature}
                            </li>
                          ))}
                        </ul>
